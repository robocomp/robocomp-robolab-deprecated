 ...
 */
/** \mainpage RoboComp::laservisorComp
 *
 * \section intro_sec Introduction
 *
 * The laservisorComp component...
 *
 * \section interface_sec Interface
 *
 * laservisorComp interface...
 *
 ...
 *
 * <p>
 * The configuration file laservisorComp/etc/config ...
 * </p>
 *
 * \subsection execution_ssec Execution
 *
 * Just: "${PATH_TO_BINARY}/laservisorComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
using namespace RoboCompLaservisor;

using namespace RoboCompLaser;


class laservisorComp : public RoboComp::Application
{
private:
...
void laservisorComp::initialize()
{
...
int laservisorComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	Worker *worker = new Worker(laser_proxy);
	//Monitor thread
	...
	try
	{
		...
		// Server adapter creation and publication
		Ice::ObjectAdapterPtr adapter = communicator()->createObjectAdapter("laservisorComp");
		LaservisorI *laservisorI = new LaservisorI(worker );
		adapter->add(laservisorI, communicator()->stringToIdentity("laservisor"));
