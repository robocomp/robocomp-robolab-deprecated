...
class EvaluadorOffComp : public RoboComp::Application
{
private:
...
void EvaluadorOffComp::initialize()
{
	// Config file properties read example
	// configGetString( PROPERTY_NAME_1, property1_holder, PROPERTY_1_DEFAULT_VALUE );
	// configGetInt( PROPERTY_NAME_2, property1_holder, PROPERTY_2_DEFAULT_VALUE );
}
int EvaluadorOffComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		// Server adapter creation and publication
		Ice::ObjectAdapterPtr adapterEvaluadorOff = communicator()->createObjectAdapter("EvaluadorOffComp");
		EvaluadorOffI *evaluadoroff = new EvaluadorOffI(worker);
		adapterEvaluadorOff->add(evaluadoroff, communicator()->stringToIdentity("evaluadoroff"));

		adapterEvaluadorOff->activate();
