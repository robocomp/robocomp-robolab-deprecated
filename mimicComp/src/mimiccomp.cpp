...
class mimicComp : public RoboComp::Application
{
private:
...
void mimicComp::initialize()
{
	// Config file properties read example
	// configGetString( PROPERTY_NAME_1, property1_holder, PROPERTY_1_DEFAULT_VALUE );
	// configGetInt( PROPERTY_NAME_2, property1_holder, PROPERTY_2_DEFAULT_VALUE );
}
int mimicComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
EvaluadorOffPrx evaluadoroff_proxy;
	...
	try
	{
		...
		// Server adapter creation and publication
		Ice::ObjectAdapterPtr adapterMimic = communicator()->createObjectAdapter("MimicComp");
		MimicI *mimic = new MimicI(worker);
		adapterMimic->add(mimic, communicator()->stringToIdentity("mimic"));

		adapterMimic->activate();
