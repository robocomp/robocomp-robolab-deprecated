...
class blackboardComp : public RoboComp::Application
{
private:
...
void blackboardComp::initialize()
{
	// Config file properties read example
	// configGetString( PROPERTY_NAME_1, property1_holder, PROPERTY_1_DEFAULT_VALUE );
	// configGetInt( PROPERTY_NAME_2, property1_holder, PROPERTY_2_DEFAULT_VALUE );
}
int blackboardComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	mprx["CameraProxy"] = (::IceProxy::Ice::Object*)(&camera_proxy);
	...
	try
	{
		...
		// Server adapter creation and publication
		Ice::ObjectAdapterPtr adapter = communicator()->createObjectAdapter("blackboardComp");
