 ...
 */
/** \mainpage RoboComp::moleComp
 *
 * \section intro_sec Introduction
 *
 * The moleComp component...
 *
 ...
 *
 * <p>
 * The configuration file moleComp/etc/config ...
 * </p>
 *
 * \subsection execution_ssec Execution
 *
 * Just: "${PATH_TO_BINARY}/moleComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class moleComp : public RoboComp::Application
{
private:
...
int moleComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		// Server adapter creation and publication
		Ice::ObjectAdapterPtr adapter = communicator()->createObjectAdapter("moleComp");
		MoleI *moleI = new MoleI(worker );
		adapter->add(moleI, communicator()->stringToIdentity("mole"));
