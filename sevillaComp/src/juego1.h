...
// 	float X,Y,Z, Xb,Yb,Zb;
	...
	public:
		...
		Juego1 ( osg::ref_ptr< osg::Camera > _cam, osg::ref_ptr< osgART::Tracker > _tracker, RoboCompArmrocio::ArmrocioPrx _arm,RoboCompSpeech::SpeechPrx _speech, QFrame* parent = 0);
		void changePosition ( );	
		void computeGame();
