 ...
 */
/** \mainpage RoboComp::terapiaComp
 *
 * \section intro_sec Introduction
 *
 * The terapiaComp component...
 *
 * \section interface_sec Interface
 *
 * terapiaComp interface...
 *
 ...
 *
 * <p>
 * The configuration file terapiaComp/etc/config ...
 * </p>
 *
 * \subsection execution_ssec Execution
 *
 * Just: "${PATH_TO_BINARY}/terapiaComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class TerapiaComp : public RoboComp::Application
{
private:
...
int TerapiaComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		Ice::ObjectAdapterPtr adapter = communicator()->createObjectAdapter("TerapiaComp");
		TerapiaI *terapiaI = new TerapiaI(worker );
		adapter->add(terapiaI, communicator()->stringToIdentity("terapia"));
