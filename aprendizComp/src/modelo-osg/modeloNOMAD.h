...
#ifndef MODELONOMAD_H
#define MODELONOMAD_H
...
namespace osgDTE {
  ...
  class modeloNOMAD: public modelo {
  ...
  public:
    ...
    modeloNOMAD(osgDTE::observadormodelocoli* pobs,osgDTE::observadormodelo* obs) 
    {
    ...
    modeloNOMAD(osgDTE::observadormodelocoli* pobs) 
    {
  ...
  protected:
    ...
    // Funciones para mover los hombros a partir del giro en X del brazo, relativo al plano sagital (inicial)
    void mueveHombroIzq();
    void mueveHombroDer();
