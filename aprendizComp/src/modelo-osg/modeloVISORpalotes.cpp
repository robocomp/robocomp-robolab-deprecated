...
namespace osgDTE {
  ...
  MatrixTransform* crearBolaDinamica2(const char* nombre, const osg::Vec4& color, 
  ...
  void modeloVISORpalotes::crearsegmentos() 
  { 
    Group* aux = new Group();
    ...
    osg::ref_ptr<osg::Node> node = cajaGrupo(osg::Vec3d(0.0f,0.0f,9.75f),2.5f,2.5f,19.5f,VERDE);
    if (node.valid()) {
    ...
    node = cajaGrupo(osg::Vec3d(0.0f,0.0f,12.5f),2.5f,2.5f,25.0f,VERDE);
    if (node.valid()) {
    ...
    node = cajaGrupo(osg::Vec3d(0.0f,0.0f,16.75f),2.5f,2.5f,33.5f,VERDE);
    if (node.valid()) {
    ...
    node = cajaGrupo(osg::Vec3d(0.0f,0.0f,18.25f),2.5f,2.5f,36.5f,VERDE);
    if (node.valid()) {
    ...
    node = cajaGrupo(osg::Vec3d(0.0f,0.0f,21.25f),2.5f,2.5f,42.5f,VERDE);
    if (node.valid()) {
  ...
  modelo::joint* modeloVISORpalotes::accedeJoint(std::string nombre_joint)
  {
  ...
  void modeloVISORpalotes::mueveModelo(const osg::Vec3d& donde)
  {
  ...
  void modeloVISORpalotes::linksMovidos(int i, std::vector<std::string>* lista)
  {
    switch (i)
      {
      case 19:
  ...
  void modeloVISORpalotes::limitesDefecto()
  {
  ...
  void modeloVISORpalotes::colisionesDefecto()
  {
    // No tiene sentido calcular colisiones en una sticky figure
  }
  
  // Comprobación de ángulos para el modelo de persona
  double modeloVISORpalotes::enlimitesInt(int articulacion, double angulo)
  {
    switch (articulacion)
      {
      /*case 6:
	...
	break;
      ...
      default:
	cerr<<"modeloVISORpalotes: Indice de articulacion no valido"<<endl; 
	break;
      } 
  ...
  // Comprobación de ángulos para el modelo de persona
  bool modeloVISORpalotes::enlimites(int articulacion, double angulo)
  {
    switch (articulacion)
      {
      case 6:
  ...
  void modeloVISORpalotes::agrandaModelo(double factor) 
  {
    _scale *= factor; 
    cambiarTamanio(_scale, jCintura); 
  ...
  void modeloVISORpalotes::achicaModelo(double factor) 
  {
    _scale /= factor; 
    cambiarTamanio(_scale, jCintura); 
    cout << "Factor de escala del modelo: " << _scale << endl;
  ...
  void modeloVISORpalotes::setAlturaCara(int altura_cm)
  {
  ...
  int modeloVISORpalotes::devuelveAltura()
  {
  ...
  std::vector<osg::Vec3f> modeloVISORpalotes::obtieneDatosModelo3D()
  {
  ...
  void modeloVISORpalotes::situaMarcadoresVirtualesCODA()
  {
    MatrixTransform* aux;
    ...
    // Codo derecho alto
    aux = crearBolaDinamica2("Right Elbow Up", VERDE, osg::Vec3f(-5.0f,0.0f,0.0f), 1.0f);
    ...
    // Codo izquierdo bajo
    aux = crearBolaDinamica2("Left Elbow Down", VERDE, osg::Vec3f(-5.0f,0.0f,0.0f), 1.0f);
    ...
    // Cabeza izquierda
    aux = crearBolaDinamica2("Left Head", VERDE, osg::Vec3f(7.5f,0.0f,17.0f), 1.0f);
    marcadoresVirtuales.at(20) = aux;
    jCabeza.trf->addChild(marcadoresVirtuales.at(20)); // La sien es hija de la cabeza...

    // Centro de la cabeza
    aux = crearBolaDinamica2("Neck", VERDE, osg::Vec3f(0.0f,0.0f,17.0f), 1.0f);
  ...
  std::vector<osg::Vec3f> modeloVISORpalotes::obtieneDatosVirtualesCODAModelo3D()
  {
    vector<osg::Vec3f> result;
  ...
  //
  std::vector<double> modeloVISORpalotes::apuntaIKBrazoDerAn(const osg::Vec3d& donde)
  {
  ...
  //  Ver tesis de Joel Mitchelson (2003)
  //
  std::vector<double> modeloVISORpalotes::apuntaIKBrazoIzqAn(const osg::Vec3d& donde)
  {
    // Matrices de resultados parciales
    osg::Matrix homb;
    osg::Matrix cod;
  ...
  // Función para obtener alternativas a la posición del codo derecho, para el modeloVISORpalotes.
  ...
  std::vector<osg::Vec3d>  modeloVISORpalotes::alternativasBrazoDer(int opciones, double angmax)
  {
  ...
  // Función para obtener alternativas a la posición del codo izquierdo, para el modeloVISORpalotes.
  // ENTRADAS: 
  //   int opciones - Número de alternativas que va a ofrecer la función
  ...
  //   posición de referencia a las más alejadas
  std::vector<osg::Vec3d>  modeloVISORpalotes::alternativasBrazoIzq(int opciones, double angmax)
  {
    std::vector<osg::Vec3d> opc(opciones);
    bool par = true;
    double theta;
  ...
  // la mano (Persona)
  std::vector<double> modeloVISORpalotes::apuntaBrazoDer(const osg::Vec3d& codo, const osg::Vec3d& donde)
  {
    // Matrices de resultados parciales
    osg::Matrix homb;
    osg::Matrix cod;
  ...
  // la mano (Persona)
  std::vector<double> modeloVISORpalotes::apuntaBrazoIzq(const osg::Vec3d& codo, const osg::Vec3d& donde)
  {
    // Matrices de resultados parciales
    osg::Matrix homb;
    osg::Matrix cod;
  ...
  void modeloVISORpalotes::giraBrazoIzq(const std::vector<double> & radianes)
  {
  ...
  void modeloVISORpalotes::giraBrazoDer(const std::vector<double> & radianes)
  {
    assert(radianes.size() == 4);
  ...
  bool modeloVISORpalotes::mueveCabeza(const osg::Vec3d& cabeza)
  {
  ...
  bool modeloVISORpalotes::alineaHombros(const osg::Vec3d& hombroizq, const osg::Vec3d& hombroder)
  {
  ...
  bool modeloVISORpalotes::mueveBrazoIzq(const osg::Vec3d& manoizq, const osg::Vec3d& codoizq)
  {
    int ki;
  ...
  bool modeloVISORpalotes::mueveBrazoDer(const osg::Vec3d& manoder, const osg::Vec3d& cododer)
  {
    int ki;
    bool angulo_valido[4];
...
//Descomentar  
 std::vector<double> modeloVISORpalotes::mueveBrazoIzq(const osg::Vec3d& manoizq,std::vector<double> angulos_brazo_izq, std::vector<double> angulos_pos_ant, const osg::Vec3d& codoizq)
  {
    int ki;
    bool angulo_valido[4];
...
return angulos_brazo_izq1;
 ...
 //Descomentar bool modeloVISORpalotes::mueveBrazoDer(const osg::Vec3d& manoder)
std::vector<double> modeloVISORpalotes::mueveBrazoDer(const osg::Vec3d& manoder,std::vector<double> angulos_brazo_der, std::vector<double> angulos_pos_ant, const osg::Vec3d& cododer)
  {
    int ki;
    bool angulo_valido[4];
