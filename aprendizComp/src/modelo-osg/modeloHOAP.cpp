...
namespace osgDTE {
  ...
  void modeloHOAP::crearsegmentos()
  {
    // Representar ZMP del HOAP
    ...
    osg::ref_ptr<osg::Node> node = osgDB::readNodeFile(string("../../data/HOAPcintura.osg"));
    ...
    node = osgDB::readNodeFile(string("../../data/HOAPpecho.osg"));
    if (node.valid()) {
    ...
    node = osgDB::readNodeFile(string("../../data/HOAPcabeza.osg"));
    ...
    node = osgDB::readNodeFile(string("../../data/HOAPbrazo.osg"));
    ...
    node = osgDB::readNodeFile(string("../../data/HOAPantebrazo.osg"));
    if (node.valid()) jAntebrazoIzq.trf->addChild(node.get());
    jAntebrazoIzq.dirsegmento.set(0.0f,0.0f,72.0f); // OJO ESTE NO COINCIDE CON EL DEL HOAP (hay que retocar el modelo 3D)...
    ...
    jAntebrazoDer.dirsegmento.set(0.0f,0.0f,72.0f); // OJO ESTE NO COINCIDE CON EL DEL HOAP (hay que retocar el modelo 3D)...
    ...
    node = osgDB::readNodeFile(string("../../data/HOAPpierna.osg"));
    ...
    node = osgDB::readNodeFile(string("../../data/HOAPpantorrilla2.osg"));
    ...
    node = osgDB::readNodeFile(string("../../data/HOAPpie.osg"));
  ...
  modelo::joint* modeloHOAP::accedeJoint(std::string nombre_joint)
  {
    ...
    cout<<"AVISO: No se ha encontrado el joint "<<nombre_joint<<" en el modelo del HOAP"<<endl;
    return 0;
  }
  
  void modeloHOAP::mueveModelo(const osg::Vec3d& donde)
  {
    jCintura.trf->setMatrix(osg::Matrix::translate(donde));
  }
  
  void modeloHOAP::reset()
  {
    jCintura.trf->setMatrix(osg::Matrix::translate(0.0,0.0,237.0));
    jPecho.trf->setMatrix(osg::Matrix::translate(0.0f,-2.0f, 30.0f));
    jCabeza.trf->setMatrix(osg::Matrix::translate(0.0f,0.0f,145.5f));  		 	
  ...
  void modeloHOAP::linksMovidos(int i, std::vector<std::string>* lista)
  {
    switch (i)
      {
      case 19:
  ...
  void modeloHOAP::limitesDefecto()
  {
  ...
  void modeloHOAP::colisionesDefecto()
  {
...
//  }
  ...
  // Comprobación de ángulos para el modelo de HOAP
  double modeloHOAP::enlimitesInt(int articulacion, double angulo)
  {
    switch (articulacion)
      {
      case 6:
	...
	break;
      ...
      default:
	cerr<<"modeloHOAP: Indice de articulacion no valido"<<endl; 
	break;
      } 
  ...
  // Comprobación de ángulos para el HOAP
  bool modeloHOAP::enlimites(int articulacion, double angulo)
  {
    switch (articulacion)
      {
      case 0:
  ...
  void modeloHOAP::calculaZMP(double intervalo)
  {
  ...
  void modeloHOAP::actualizadatos(double intervalo)
  {
  ...
  std::vector<double> modeloHOAP::apuntaIKBrazoDerAn(const osg::Vec3d& donde)
  {
    ...
    // OFFSETS PARA EL HOAP-1
    // Como los ejes de giro del HOAP son un poco distintos a los de coordenadas locales, y como
    // los ángulos iniciales también son distintos, es necesario utilizar offsets para adaptar 
    // los valores anteriores al HOAP-1
  ...
  std::vector<double> modeloHOAP::apuntaIKBrazoIzqAn(const osg::Vec3d& donde)
  {
    // Matrices de resultados parciales
    osg::Matrix homb;
    osg::Matrix cod;
  ...
  std::vector<osg::Vec3d>  modeloHOAP::alternativasBrazoDer(int opciones, double angmax)
  {
  ...
  //   posición de referencia a las más alejadas
  std::vector<osg::Vec3d>  modeloHOAP::alternativasBrazoIzq(int opciones, double angmax)
  {
    std::vector<osg::Vec3d> opc(opciones);
    bool par = true;
    double theta;
  ...
  // la mano (Persona)
  std::vector<double> modeloHOAP::apuntaBrazoDer(const osg::Vec3d& codo, const osg::Vec3d& donde)
  {
    // Matrices de resultados parciales
    osg::Matrix homb;
    osg::Matrix cod;
  ...
  // la mano (Persona)
  std::vector<double> modeloHOAP::apuntaBrazoIzq(const osg::Vec3d& codo, const osg::Vec3d& donde)
  {
    // Matrices de resultados parciales
    osg::Matrix homb;
    osg::Matrix cod;
  ...
  void modeloHOAP::giraBrazoIzq(const std::vector<double> & radianes)
  {
  ...
  void modeloHOAP::giraBrazoDer(const std::vector<double> & radianes)
  {
    assert(radianes.size() == 4);
  ...
  bool modeloHOAP::mueveCabeza(const osg::Vec3d& cabeza)
  {
  ...
  bool modeloHOAP::mueveBrazoIzq(const osg::Vec3d& manoizq, const osg::Vec3d& codoizq)
  {
    int ki;
	...
	/*alternatas = this->alternativasBrazoIzqHOAP (alter);   
...
//RETARGETING ANGULOS
 std::vector<double> modeloHOAP::mueveBrazoIzq(const osg::Vec3d& manoizq,std::vector<double> angulos_brazo_izq,std::vector<double> ang_left_pos_ant, const osg::Vec3d& codoizq)
 {
    int ki;
    bool angulo_valido[4];
    // NUEVO 
...
//FIN RETARGETING ANGULOS
  bool modeloHOAP::mueveBrazoDer(const osg::Vec3d& manoder, const osg::Vec3d& cododer)
  {
    int ki;
    bool angulo_valido[4];
...
std::vector<double> modeloHOAP::mueveBrazoDer(const osg::Vec3d& manoder,std::vector<double> angulos_brazo_der,std::vector<double> ang_right_pos_ant, const osg::Vec3d& cododer)
  {
    int ki;
    bool angulo_valido[4];
...
//FIN RETARGETING ANGULOS
  ...
  void modeloHOAP::setAlturaCara(int altura_cm)
  {
  ...
  int modeloHOAP::devuelveAltura()
  {
    ...
    return( (int)(altura/10) );   // Se divide entre 10 porque las medidas del HOAP están orig. en mm.
  }
