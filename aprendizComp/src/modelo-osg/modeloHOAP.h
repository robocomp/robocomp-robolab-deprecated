...
namespace osgDTE {
  ...
  class modeloHOAP: public modelo {
  ...
  public:
    ...
    modeloHOAP(osgDTE::observadormodelocoli* pobs,osgDTE::observadormodelo* obs) 
    {
    ...
    modeloHOAP(osgDTE::observadormodelocoli* pobs) 
    {
  ...
  class UpdateZMPCallback : public osg::NodeCallback
  {
  public:
    bool _firstCall;
    ...
    {
      modeloHOAP* m = dynamic_cast<modeloHOAP*>(node);
