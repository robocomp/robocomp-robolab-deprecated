 ...
 */
/** \mainpage RoboComp::aprendizComp
 *
 * \section intro_sec Introduction
 *
 * The aprendizComp component...
 *
 * \section interface_sec Interface
 *
 * aprendizComp interface...
 *
 ...
 *
 * <p>
 * The configuration file aprendizComp/etc/config ...
 * </p>
 *
 * \subsection execution_ssec Execution
 *
 * Just: "${PATH_TO_BINARY}/aprendizComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class aprendizComp : public RoboComp::Application
{
private:
...
int aprendizComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		// Server adapter creation and publication
		Ice::ObjectAdapterPtr adapter = communicator()->createObjectAdapter("aprendizComp");
		AprendizI *aprendizI = new AprendizI(worker );
		adapter->add(aprendizI, communicator()->stringToIdentity("aprendiz"));
