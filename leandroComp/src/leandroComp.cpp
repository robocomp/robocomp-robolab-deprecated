 ...
 */
/** \mainpage RoboComp::leandroComp
 *
 * \section intro_sec Introduction
 *
 * The leandroComp component...
 *
 * \section interface_sec Interface
 *
 * leandroComp interface...
 *
 ...
 *
 * <p>
 * The configuration file leandroComp/etc/config ...
 * </p>
 *
 * \subsection execution_ssec Execution
 *
 * Just: "${PATH_TO_BINARY}/leandroComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class leandroComp : public RoboComp::Application
{
private:
...
int leandroComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	{
		// Load the remote server proxy
		proxy = getProxyString("CameraProxy");
	...
	Worker *worker = new Worker(camera_proxy, kinect_proxy);
	//Monitor thread
	...
	try
	{
		...
		// Server adapter creation and publication
		Ice::ObjectAdapterPtr adapter = communicator()->createObjectAdapter("leandroComp");
		LeandroI *leandroI = new LeandroI(worker );
		adapter->add(leandroI, communicator()->stringToIdentity("leandro"));
